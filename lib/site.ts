...
export const downloadTargets: DownloadTarget[] = [
    {
        ...
        install: 'Install with: sudo apt install ./Elcro-Linux-x64.deb  (or open the .deb in your software center). Creates an Applications menu entry with the Elcro icon. Portable tar.gz remains available for manual runs.',
        available: true,
    },
    {
        os: 'Windows',
...
const docsPages: SitePage[] = [
    ...
    info('docs/install', 'Install', 'Documentation', 'Install Elcro on your platform.', 'Elcro ships desktop apps for Windows, macOS, and Linux. Download the build for your platform from the download page.', ['Windows', 'macOS', 'Linux'], [
        { title: 'Windows and macOS', body: 'On Windows, download ElcroUserSetup-x64.exe and follow the install wizard. On macOS, open the .dmg and drag Elcro.app into Applications. On Linux, install the .deb package. On first launch, complete onboarding.' },
